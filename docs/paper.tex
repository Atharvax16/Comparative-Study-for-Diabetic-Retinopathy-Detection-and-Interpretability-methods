...
\begin{tabular}{llccc}
\toprule
\textbf{Degradation} & \textbf{Restorer} & \textbf{$\Delta$PSNR (dB)} & \textbf{$\Delta$SSIM} & \textbf{$\Delta$Acc} \\
\midrule
